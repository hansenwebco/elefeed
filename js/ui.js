...
const filterLabels = { all: 'All', following: 'Followed Profiles', hashtags: 'Followed Hashtags', lists: 'Lists' };
const filterLabelsMobile = { all: 'All', following: 'Following', hashtags: 'Hashtags', lists: 'Lists' };
